 ...
 * @author Marchelo
 */
public class FrPsp extends javax.swing.JFrame {
...
//            System.out.println(dato+""+cant);
    ...
    public ClPsp insert() {
        ...
        if (txtRuta.getText().length() > 0) {
            ...
            String ruta = "./src/Cl/Burgos/Juegos/IMG/PSP.png";
    ...
    public ClPsp actualizar() {
        ClPsp clPsp= null;
        String capasid = jcCapasidad.getSelectedItem().toString();
        if(txtRuta.getText().length()>0){
            archivos.CopiarArchivos(txtRuta.getText(), System.getProperties().getProperty("user.dir")+"/IMG/PSP/"+txtCodigo.getText().trim()+".jpg");
            clPsp = new ClPsp(id, txtCodigo.getText().trim(), txtNombre.getText().trim(), txtRegion.getText().trim(), txtIdiomas.getText().trim(), jsJugadores.getValue().hashCode(), txtDisco.getText().trim() + " " + capasid, txtRuta.getText());
        }else{
            clPsp = new ClPsp(id, txtCodigo.getText().trim(), txtNombre.getText().trim(), txtRegion.getText().trim(), txtIdiomas.getText().trim(), jsJugadores.getValue().hashCode(), txtDisco.getText().trim() + " " + capasid, txtRuta.getText());
        }
        return clPsp;
    ...
    public ClPsp eliLis() {
        ClPsp clPsp = new ClPsp(id);
        return clPsp;
    }

    public void defineTablaPsp() {
        long lngRegistros = 1;
...
//        DAOPc classCliente= new DAOPc();
        ...
        List<ClPsp> lista = dAOPsp.leerPsp();
...
//        this.jlblTotalPaginas.setText(" De " + ( lngNumPaginas));
    ...
    public void defineTablaPspBuscar(ClPsp psp){
        long lngRegistros=1;
        long lngDesdeRegistro;
...
//        DAOPc classCliente= new DAOPc();
        ...
        //LEEMOS LA CLASE CLIENTE MANDANDOLE LOS PARAMETROS
        //dAOClaves.leerClientesId(lngDesdeRegistro, (Long.valueOf(this.txtNumReg.getText())),tablaClientes,strBusqueda,idCliente);
        List<ClPsp> lista=dAOPsp.leerBuscar(psp);
        Object fila[] = new Object[8];
//        String datos[]=new String [3];
        for (int i = 0; i < lista.size(); i++) {
            fila[0]=Integer.toString(lista.get(i).getId());
...
//        this.jlblTotalPaginas.setText(" De " + ( lngNumPaginas));
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblImgen, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE))
        );
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        // TODO add your handling code here:
        if (!dAOPsp.sqlUpdate(actualizar())) {
    ...
    private void btnDescarImgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDescarImgActionPerformed
        ...
        try {
            List<ClPsp> datosCliente = dAOPsp.leerPsp2(eliLis());
...
//                nombre=datosCliente.get(i).getCodigo()+"-"+datosCliente.get(i).getNombre()+".png";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        ClPsp clPsp= null;
        clPsp = new ClPsp(txtCodigo.getText().trim(), txtNombre.getText().trim());
        defineTablaPspBuscar(clPsp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrPsp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
